    ...
    <div className="h-[40rem] w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        ...
        <input
          ...
          className="rounded-lg border border-ring-brandPrimary focus:ring-2 focus:ring-brandPrimary  w-full relative z-10 mt-4  bg-neutral-100 placeholder:text-neutral-700"
        />
      </div>
      <BackgroundBeams />
    </div>
